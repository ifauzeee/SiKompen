...
export default async function SettingsPage() {
  ...
  const defaultSettings = [
    ...
    {
      key: "batas_jam_kompen",
      value: "100",
      description: "Batas maksimum jam kompen per mahasiswa",
    },
    {
      key: "bank_account",
      value: "BNI 1234567890 a.n. Politeknik Negeri Jakarta",
      description: "Informasi rekening pembayaran kompen",
    },
  ];
