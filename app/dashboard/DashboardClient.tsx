...
export default function DashboardClient({
  ...
  return (
    <div
      ref={container}
      className="mx-auto min-h-screen max-w-[1600px] space-y-8 px-4 pt-8 pb-12 sm:px-8"
    >
      <header className="mb-4 flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
        ...
        <div className="welcome-text hidden items-center gap-3 rounded-full border border-gray-200 bg-white px-5 py-2.5 shadow-sm md:flex">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
        ...
        <div className="bento-item group col-span-1 flex flex-col justify-between rounded-4xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-100/50 transition-colors duration-300 hover:border-[#CE2029]/30 md:col-span-1 md:rounded-[2.5rem]">
          <div>
            ...
            <p className="text-xs font-bold tracking-wider text-gray-400 uppercase md:text-sm">
              Sedang Dikerjakan
            </p>
        ...
        <div className="bento-item group col-span-1 flex flex-col justify-between rounded-4xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-100/50 transition-colors duration-300 hover:border-[#F4B41A]/30 md:col-span-1 md:rounded-[2.5rem]">
          <div>
            <div className="mb-4 flex items-start justify-between">
        ...
        <div className="bento-item group relative col-span-1 flex flex-col justify-between overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-100/50 md:col-span-2 md:rounded-[2.5rem] md:p-8 lg:col-span-2">
          ...
          <div>
            <div className="relative z-10 mb-6 flex items-center justify-between">
              <h3 className="flex items-center gap-2 text-base font-bold text-gray-900 md:text-lg">
            ...
            <div className="relative z-10 mb-2 flex items-end gap-3">
              <span className="text-3xl font-black tracking-tight text-gray-900 md:text-5xl">
            ...
            <p className="relative z-10 mb-8 text-xs font-medium text-gray-400 md:text-sm">
          ...
          <div className="relative z-10">
            <div className="h-6 w-full overflow-hidden rounded-full bg-gray-100 p-1">
              <div
        ...
        <div className="bento-item col-span-1 flex h-full flex-col overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-100/50 md:col-span-1 md:rounded-[2.5rem] md:p-8 lg:col-span-2">
          <h3 className="mb-6 flex items-center gap-2 text-base font-bold text-gray-900 md:text-lg">
              ...
              activities.map((act) => (
                ...
                >
                  ...
                  <div className="mb-1 flex items-start justify-between gap-4">
                    ...
                    <span className="shrink-0 rounded-full bg-gray-50 px-2 py-0.5 text-[10px] font-semibold whitespace-nowrap text-gray-400">
                      {act.time}
                    </span>
                  </div>
        ...
        <div className="bento-item group col-span-1 flex h-full flex-col justify-between overflow-hidden rounded-4xl border border-gray-100 bg-white p-6 shadow-xl shadow-gray-100/50 transition-colors hover:border-[#008C9D]/30 md:col-span-1 md:rounded-[2.5rem] md:p-8 lg:col-span-2">
