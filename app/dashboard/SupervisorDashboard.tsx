...
export default function SupervisorDashboard({ user, stats, applications, acceptedApplications }: SupervisorDashboardProps) {
    ...
    return (
        <div className="pt-8 px-4 sm:px-8 max-w-[1600px] mx-auto min-h-screen pb-12 space-y-8">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-4">
                ...
                <Link href="/jobs/create" className="flex items-center gap-2 px-6 py-3 bg-[#008C9D] text-white rounded-xl font-bold hover:bg-[#007A8A] hover:shadow-lg shadow-[#008C9D]/20 transition-all active:scale-95">
                    <PlusCircle size={20} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link href="/dashboard/my-jobs" className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-100/50 flex flex-col justify-between group hover:border-[#008C9D]/30 transition-all duration-300 h-full">
                    ...
                    <div>
                        ...
                        <h3 className="text-5xl font-black text-gray-900 mt-2">{stats?.myJobs || 0}</h3>
                    </div>
                </Link>

                <div className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-xl shadow-gray-100/50 flex flex-col justify-between group hover:border-[#F4B41A]/30 transition-all duration-300 h-full">
                    <div className="flex justify-between items-start mb-6">
                    ...
                    <div>
                        ...
                        <h3 className="text-5xl font-black text-gray-900 mt-2">{stats?.pendingValidations || 0}</h3>
                    </div>
                </div>

                <div className="bg-gradient-to-br from-[#008C9D] to-[#007A8A] text-white p-8 rounded-[2.5rem] shadow-xl shadow-[#008C9D]/20 flex flex-col justify-between group relative overflow-hidden h-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-white rounded-[2.5rem] p-8 border border-gray-100 shadow-xl shadow-gray-100/50">
                        <div className="flex justify-between items-center mb-8">
                            <div>
                                <h3 className="text-2xl font-bold text-gray-900">Validasi Pelamar</h3>
                                <p className="text-gray-500 text-sm mt-1">Setujui pelamar agar mereka dapat mulai bekerja.</p>
                            </div>
                            <span className="bg-[#F4B41A]/10 text-[#F4B41A] px-4 py-1.5 rounded-full text-sm font-bold">
                ...
                <div className="space-y-6">
                    <div className="bg-gray-900 rounded-[2.5rem] p-8 shadow-xl text-white relative overflow-hidden border border-gray-800">
